...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">Editar Centro de Custo</h4>
            ...
            <form action="{{ route('admin.financeiro.centros.update', $centro) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nome" class="form-control"
                           value="{{ old('nome', $centro->nome) }}" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Descrição (opcional)</label>
                    <textarea name="descricao" class="form-control" rows="3">{{ old('descricao', $centro->descricao) }}</textarea>
                </div>
