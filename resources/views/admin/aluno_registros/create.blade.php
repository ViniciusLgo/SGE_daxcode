...
@section('content')
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="{{ route('aluno_registros.store') }}" method="POST" enctype="multipart/form-data" class="row g-3">
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-12 d-flex justify-content-between mt-3">
                    ...
                    <button class="btn btn-success"><i class="bi bi-save"></i> Salvar</button>
                </div>
            </form>
        </div>
    </div>
