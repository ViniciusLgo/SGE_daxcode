...
@section('content')
    ...
    @php
        // Pendencias APENAS de atendimentos (status = pendente)
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500">
                    Historico de solicitacoes administrativas registradas.
                </p>
            </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-yellow-700 dark:text-yellow-400">
                            Existem <strong>{{ $pendentes }}</strong> atendimentos aguardando resolucao.
                        </p>
                    </div>
                </div>
            </div>
